---
title: "Stitching a Visium Experiment"
author: 
...
Much of the `visiumStitched` package uses a tibble (or dataframe) defining information
...
capture area, and the stitched approximately high-resolution image. These files are also
